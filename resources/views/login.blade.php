  ...
  <body>
    ...
    <section class="login-content">
      ...
      @if(Session::has('alert'))
       ...
       @endif 
      <div class="login-box">
        <form class="login-form" action="{{route('loginprocess')}}" method="get">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>ĐĂNG NHẬP</h3>
          <div class="form-group">
            <label class="control-label">TÀI KHOẢN</label>
            <input class="form-control" type="text" placeholder="Nhập tài khoản" autofocus name="txttaikhoan">
          </div>
          <div class="form-group">
            <label class="control-label">MẬT KHẨU</label>
            <input class="form-control" type="password" placeholder="Nhập mật khẩu" name="txtmatkhau">
          </div>
          <div class="form-group">
            <div class="utility">
